...
class StockDailyPriceUS(BaseModel):
    """股票价格类"""
...
class StockBasicInfoUS(BaseModel):
    """美股基本信息类"""
    ticker: str = Field(description="股票代码", index=True)
...
class StockTechnicalIndicatorsUS(BaseModel):
    ticker: str = Field(description="股票代码", index=True)
    trade_date: Optional[str] = Field(None, description="交易日期", index=True)
...
class StockTechnicalTrendSignalIndicatorsUS(BaseModel):
    ticker: str = Field(description="股票代码", index=True)
    trade_date: Optional[str] = Field(None, description="交易日期", index=True)
...
class StockTechnicalMeanReversionSignalIndicatorsUS(BaseModel):
    ticker: str = Field(description="股票代码", index=True)
    trade_date: Optional[str] = Field(None, description="交易日期", index=True)
...
class StockTechnicalMomentumSignalIndicatorsUS(BaseModel):
    ticker: str = Field(description="股票代码", index=True)
    trade_date: Optional[str] = Field(None, description="交易日期", index=True)
...
class StockTechnicalVolatilitySignalIndicatorsUS(BaseModel):
    ticker: str = Field(description="股票代码", index=True)
    trade_date: Optional[str] = Field(None, description="交易日期", index=True)
...
class StockTechnicalStatArbSignalIndicatorsUS(BaseModel):
    ticker: str = Field(description="股票代码", index=True)
    trade_date: Optional[str] = Field(None, description="交易日期", index=True)
...
class StockMarketIndexUS(BaseModel):
    """股票市场指数信息类"""
...
# 公司股票财务指标数据
class FinancialMetricsUS(BaseModel):
    """公司财务指标类"""
    ticker: str = Field(description="股票代码", index=True)
